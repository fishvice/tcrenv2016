...
#### [Applied data and graph grammar 1](pre/more_grammar01.html)

[The source document](pre/more_grammar01.Rmd)

### Potential projects (not all links yet active)
...
#### [Nice catch colours](Multispecies_IGFS_DATRAS_maps.html)

#### [The crayola survey](crayola_survey.html)

[The source document](adhoc/crayola_survey.Rmd)

#### [FLR %>% dplyr %>% ggplot](flr.html)

[The source document](adhoc/flr.Rmd)

#### [Small date drill](datras_date_drill.html)
