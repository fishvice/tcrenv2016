...
```{r ices_fmort_mspecies, message = FALSE, warning = FALSE}
rby %>% 
...
Plot the stuff:
```{r nsibts, message = FALSE, warning = FALSE}
...
```{r icod, fig.width = 9.5, fig.height = 6, warning = FALSE}
d %>% 
